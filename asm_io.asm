...
segment .text
%endif
	global	read_int, print_int, print_string, read_char, print_double, print_array, print_float_array
	global  print_char, print_nl, sub_dump_regs, sub_dump_mem
        global  sub_dump_math, sub_dump_stack, print_float
...
print_float:
	...
	mov		[floating_temp], eax
	fld		dword [floating_temp]
	fstp	qword [floating_temp]
	push	dword [floating_temp+4]
	push	dword [floating_temp]
	push	dword float_format
	call	_printf
	pop 	ecx
	pop		ecx
	pop		ecx
	mov		dword [floating_temp], 0
	mov		dword [floating_temp+4], 0
